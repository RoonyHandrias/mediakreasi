...
<body>
  ...
  <div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(5, 42, 62, 0.247);" data-300="line-height:60px; height:60px; background-color:rgba(5, 42, 62, 1);">
    <div class="container" style="overflow: unset">
      <div class="navbar-header d-flex">
        ...
        <div class="navbar-logo col-sm-3">
          <a href="index.php"><img data-0="width:200px;" data-300=" width:150px;" src="assets/img/logomk.png" alt="" width="100%"></a>
        </div>
      </div>
