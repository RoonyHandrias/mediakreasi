...
$query = mysqli_query($koneksi, "SELECT * FROM transaksi JOIN konfirmasi_pembayaran ON transaksi.id_transaksi =  konfirmasi_pembayaran.id_transaksi JOIN user ON transaksi.id_user = user.id_user JOIN ongkir ON transaksi.metode_pengiriman WHERE transaksi.id_transaksi = '$id_transaksi'");
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            ...
            <?php if ($_SESSION['level'] == 'admin' && $transaksi['status'] == 0): ?>
                <br><br>
